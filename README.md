...
Here's a list of tokens you can set up in system variables to bring more functionality to Poopy:
  ...
  - `DISCORD_REFRESHER_TOKEN` (discord **user** token used for refreshing expired urls, without it using keywords such as _ps and _oil will generally not function if you don't manually refresh the url)
