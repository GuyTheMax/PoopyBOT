module.exports = {
  desc: 'Returns a random file sent in the server. Requires permission for the bot to read messages within channels.',
  func: function (msg) {
    let poopy = this
    ...
    var validURL = new RegExp(`${vars.validUrl.source}\\.(a?png|jpe?g|bmp|web(p|m)|gif|mp4|mov|wmv|avi)`, 'g')
